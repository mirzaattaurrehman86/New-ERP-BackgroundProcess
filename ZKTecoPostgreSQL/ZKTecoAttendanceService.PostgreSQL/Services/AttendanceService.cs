...
namespace ZKTecoAttendanceService.PostgreSQL.Services
{
    ...
    OperatingSystem.IsWindows()
        ...
        private static AttendanceRecordDto Map(NpgsqlDataReader r) => new()
        {
            ...
            StatusName = ZKTecoAttendanceService.helper.HelperClass.MapInOutMode(r.GetInt32(4)),
            VerifyModeId = r.GetInt32(6),
            VerifyModeName = ZKTecoAttendanceService.helper.HelperClass.MapVerifyMode(r.GetInt32(6)),
